...
$driverStats = \app\models\driverModel::getDriverDeliveryCountStatisticsUnderCCMonthBack($logistic->ccID);

$deliveryByDate = \app\models\deliveryModel::getDeliveriesDoneUnderCCMonthBack($logistic->ccID);

$deliveryByDistance = \app\models\deliveryModel::getDeliveriesDoneUnderCCMonthBackByDistance($logistic->ccID);
...
<script type="module" src="../../public/JS/charts/logistic/drivers/deliveryVariations.js"></script>
<script type="module" src="../../public/JS/charts/logistic/drivers/deliveryByDistance.js"></script>
