...
/**
 *@var $logistic logisticModel
 */

use app\models\logisticModel;

[ $personalInfo, $logisticStat ] =  $logistic->getLogisticInformationForProfile();
...
<div class="profile-container">
    <div class="profile">
        ...
        <form action="#" class="form-grid-1">
            ...
            <input type="hidden" id="userType" value="logistic">
    ...
    <div class="stats display-grid columns-3 rows-2">
        ...
        <?php foreach ($logisticStat as $key => $value) {
